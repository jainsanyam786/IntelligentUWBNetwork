...
title("Diff b/w 1st and 2nd Max w.r.t to SNR for PN Sequence code");
...
title("Delay w.r.t to SNR for PN Sequence code");
...
pnSequence = comm.PNSequence('Polynomial','x^4+x+1',... 
                'InitialConditions',[0 0 0 1],'SamplesPerFrame',16);
dataToTransmit = pnSequence();
dataLength=16;
...
if (SNR == 100||SNR == -20)
    ...
    % Set axes and labels.
    title("Received data Plot for SNR" + SNR);
